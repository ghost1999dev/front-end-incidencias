...
public class InsertActivityIncidenceUser extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private static final String titulo="Reporte de incidencia";
    private static final String contenido="Se ha registrado una incidencia";
    private static final String tokenAdministrador="f5E4xc8tTk-wPP6ViwaBE-:APA91bE9ekYI1fXMczwgR0cUdwGIKTzxjjDA2WOxYeGlbl3lEAoMyWDamplFzIf2cVmpxIlAzjsNgmlup4weywrSK_RAmoHHvoa8osla058sWsk-PUUtThSce4gXaE8YPKEdrThHbYr8";
    String status="ACTIVO";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_insert_incidence_user);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equals("success")) {
                        Toast.makeText(InsertActivityIncidenceUser.this, message, Toast.LENGTH_SHORT).show();
                        loading.dismiss();
                        FCMSend.pushNotificacion(InsertActivityIncidenceUser.this,titulo,contenido,tokenAdministrador);
                        startActivity(new Intent(getApplicationContext(),IncidenceRegisterUser.class));
                        finish();
                    } else {
                        loading.dismiss();
                        Toast.makeText(InsertActivityIncidenceUser.this, message, Toast.LENGTH_SHORT).show();
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        tipoIncidenceAdapter=new ArrayAdapter<>(InsertActivityIncidenceUser.this,
